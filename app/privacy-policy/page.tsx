          ...
          <div className="prose prose-surface max-w-none space-y-8 text-surface-600 leading-relaxed text-sm">
            ...
            <section>
              ...
              <ul className="list-disc pl-5 mt-2 space-y-1">
                ...
                <li>Legitimate interest (e.g., improving our website)</li>
            ...
            <section>
              ...
              <ul className="list-disc pl-5 mt-2 space-y-1">
                <li>Service providers who assist us in delivering our services (e.g., hosting providers)</li>
                <li>Professional advisors (e.g., accountants, legal counsel)</li>
            ...
            <section>
              ...
              <p>
                ...
                by law. Contact form submissions are retained for a maximum of 12
                months unless an ongoing business relationship exists.
              </p>
            </section>
