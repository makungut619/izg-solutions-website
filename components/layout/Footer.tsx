          ...
          <div>
            ...
            <div className="flex items-center gap-4 mt-5">
              <a
                ...
                onClick={() =>
                  window.izg?.track("social_click", { platform: "instagram", page: "/footer" })
                }
              >
              ...
              <a
                ...
                className="text-surface-400 hover:text-white transition-colors"
                onClick={() =>
                  window.izg?.track("social_click", { platform: "tiktok", page: "/footer" })
                }
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              <a
                ...
                className="text-surface-400 hover:text-white transition-colors"
                onClick={() =>
                  window.izg?.track("social_click", { platform: "x", page: "/footer" })
                }
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
